...
export const DEFAULT_COLUMNS: ColumnConfig[] = [
  ...
  { id: 'upside_potential', label: 'Upside %', visible: true, order: 11 },
  { id: 'expected_value', label: 'EV %', visible: true, order: 12 },
  { id: 'probability_positive', label: 'Probability', visible: true, order: 13 },
  { id: 'downside_risk', label: 'Downside %', visible: true, order: 14 },
  { id: 'kelly_fraction', label: 'Kelly F* %', visible: true, order: 15 },
  { id: 'half_kelly_suggested', label: '½-Kelly %', visible: true, order: 16 },
  { id: 'shares_owned', label: 'Shares', visible: true, order: 17, portfolioOnly: true },
  { id: 'weight', label: 'Weight %', visible: true, order: 18, portfolioOnly: true },
  { id: 'unrealized_pnl', label: 'P&L', visible: true, order: 19, portfolioOnly: true },
  { id: 'assessment', label: 'Assessment', visible: true, order: 20 },
  { id: 'actions', label: 'Actions', visible: true, order: 21, required: true },
];
