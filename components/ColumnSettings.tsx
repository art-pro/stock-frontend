...
export const DEFAULT_COLUMNS: ColumnConfig[] = [
  ...
  { id: 'sell_zone_lower_bound', label: 'Sell Zone Min', visible: true, order: 11 },
  { id: 'sell_zone_upper_bound', label: 'Sell Zone Max', visible: true, order: 12 },
  { id: 'sell_zone_status', label: 'Sell Zone Status', visible: true, order: 13 },
  { id: 'upside_potential', label: 'Upside %', visible: true, order: 14 },
  { id: 'expected_value', label: 'EV %', visible: true, order: 15 },
  { id: 'probability_positive', label: 'Probability', visible: true, order: 16 },
  { id: 'downside_risk', label: 'Downside %', visible: true, order: 17 },
  { id: 'kelly_fraction', label: 'Kelly F* %', visible: true, order: 18 },
  { id: 'half_kelly_suggested', label: '½-Kelly %', visible: true, order: 19 },
  { id: 'shares_owned', label: 'Shares', visible: true, order: 20, portfolioOnly: true },
  { id: 'weight', label: 'Weight %', visible: true, order: 21, portfolioOnly: true },
  { id: 'unrealized_pnl', label: 'P&L', visible: true, order: 22, portfolioOnly: true },
  { id: 'assessment', label: 'Assessment', visible: true, order: 23 },
  { id: 'actions', label: 'Actions', visible: true, order: 24, required: true },
];
